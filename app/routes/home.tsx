...
const iconStylesByFeature = {
  ...
  'ai-mock-interview': 'from-fuchsia-400 to-pink-600',
} as const;
...
const iconPathsByFeature = {
  ...
  'ai-mock-interview': 'M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422A12.083 12.083 0 0112 21a12.083 12.083 0 01-6.16-10.422L12 14z',
} as const;
